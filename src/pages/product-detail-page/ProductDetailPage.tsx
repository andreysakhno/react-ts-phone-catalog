...
import { StateContext } from '../../libs/components/state-provider/state-context';
import {
  ProductsFilters,
  PAGE_RELOAD_DELAY,
  PRODUCT_COLORS,
...
import {
  ...
  getFormattedGBString,
} from '../../libs/helpers';
import { productServices as services } from '../../libs/services/product-services';
    ...
    <main className="detail">
      <div className="detail__container">
        ...
        <article className="detail__content">
          <ImagesGallery className="detail__images-gallery" images={images} />
            ...
            <div className="detail__main-info-left">
              <div className="detail__options">
                <div className="detail__option">
                  <h4 className="detail__lable">Available colors</h4>
                ...
                <div className="detail__option">
                  <h4 className="detail__lable">Select capacity</h4>
          ...
          <section className="detail__about" data-cy="productDescription">
            ...
            <div className="detail__description">
              {description.map(({ title, text }) => (
                <div key={title} className="detail__description-content">
                  <h3 className="detail__description-title">{title}</h3>

                  {text.map(item => (
                    <p key={item} className="detail__description-text">
                      {item}
                    </p>
                  ))}
                </div>
