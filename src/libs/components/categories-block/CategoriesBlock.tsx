  ...
  return (
    ...
    >
      ...
      <div className="categories-block__list">
        {categories.map(({ category, title: categoryTitle, image, link }) => (
          <div key={categoryTitle} className="categories-block__item">
            <Link
              to={link}
            ...
            <Link to={link} className="categories-block__title-link">
              {categoryTitle}
            </Link>
