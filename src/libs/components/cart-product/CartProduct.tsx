...
import { IMG_ROOT_PATH, ButtonViews, IconNames, IconColors } from '../../enums';
import {
  getCartItemWithUpdatedQuantity,
  getUpdatedListWithProduct,
} from '../../helpers';
...
export const CartProduct: React.FC<Props> = ({ productInCart }) => {
  ...
  const { id, image, category, phoneId, price, quantity } = productInCart;
  ...
  return (
    <article className="cart-product">
      ...
      <div className="cart-product__controls">
        ...
        <div className="cart-product__controls-qty">{quantity}</div>
