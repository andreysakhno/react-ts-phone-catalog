...
export const Product: React.FC<Props> = ({ product, className, ...rest }) => {
  ...
  return (
    ...
    >
      ...
      >
        <img className="product__image" src={productImgPath} alt={name} />
      </Link>
      ...
      <div className="product__info">
        ...
        <div className="product__prices">
          <div className="product__new-price">{`$${price}`}</div>
          <div className="product__old-price">{`$${fullPrice}`}</div>
        </div>
      </div>
      ...
      <div className="product__controls">
        <AddToCart product={product} className="product__btn-add-to-cart" />
